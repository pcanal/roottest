...
StepPointMC: {
  position: {1.25, 2.5, 5, 1}
  postPosition: {2.5, 5, 10, 2}
  momentum: {3.75, 7.5, 15, 3}
  postMomentum: {5, 10, 20, 4}
}
...
void writefile(int splitlevel = 9)
{
  ...
  mc.position = {1.25, 2.5, 5, 1};
  mc.postPosition = {2.5, 5, 10, 2};
  mc.momentum = {3.75, 7.5, 15, 3};
  mc.postMomentum = {5, 10, 20, 4};
  step.vec.push_back(mc);
  mc.postMomentum = {15, 20, 30, 5};
