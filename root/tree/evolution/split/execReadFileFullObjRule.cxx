...
bool readfile()
{
  ...
  tree->GetEntry(0);
  // tree->GetBranch("stepvec.")->GetEntry(0);
  // tree->GetBranch("nodot_stepvec")->GetEntry(0);
  // tree->GetBranch("nodot_directstepvec")->GetEntry(0);
  ...
  // tree->GetBranch("middle.")->Print("debugInfo");
#if 1
...
StepPointMC: {
  position: {1.25, 2.5, 5}
  postPosition: {2.5, 5, 10}
  momentum: {3.75, 7.5, 15}
  postMomentum: {5, 10, 20}
}
#endif
  ...
  // tree->GetBranch("nodot_directstepvec")->Print("debugInfo");
  // tree->GetBranch("nodot_directstepvec")->Print("debugAddress");
